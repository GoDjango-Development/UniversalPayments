...
class WellsFargoApplication(Application):
    api_id = models.CharField(max_length=100, verbose_name="API LOGIN ID", null=True, blank=True)
    api_secret = models.CharField(max_length=100, verbose_name="TRANSACTION KEY", null=True, blank=True)
